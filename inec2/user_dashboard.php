...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['billCode'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $billingInfo = ['error' => 'No billing information found for the bill code.'];
    }
        ...
        <div class="dashboard-content">
            ...
            <div class="dashboard-info">
                <div id="billing-info" class="billing-info">
                    ...
                    <!-- Always visible header names with empty boxes -->
                    <div class="info-box-container">
                        ...
                        <div class="info-box">
                            ...
                            <span class="info-value" id="due-date"><?php echo htmlspecialchars($billingInfo['amountAfterDueDate'] ?? ''); ?></span>
                        </div>
                    </div>
                ...
                <div id="myprofile" class="myprofile" style="display: none;">
                    ...
                    <div class="myprofile-groupone">
                        ...
                        <div class="info-box">
                            <span class="info-value" id="accNum"><?php echo htmlspecialchars($accNum); ?></span>
                        </div>
                    ...
                    <div class="myprofile-grouptwo">
                        <div>
                            ...
                            <div class="info-box">
                                <span class="info-value" id="profile-zoneid"></span>
                            </div>
                        </div>
                        <div>
                            <label for="townid">Town ID</label>
                            <div class="info-box">
                                <span class="info-value" id="profile-townid"></span>
                            </div>
                        </div>
                        <div>
                            <label for="accstatus">Account Status</label>
                            <div class="info-box">
                                <span class="info-value" id="profile-accstatus"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="myprofile-groupthree">
                        ...
                        <div class="info-box">
                            <span class="info-value" id="consumertype"></span>
                        </div>
                        
                        <label for="date-connected">Date Connected</label>
                        <div class="info-box">
                            <span class="info-value" id="profile-date-connected"></span>
                        </div>
                    </div>
                </div>
            </div>
